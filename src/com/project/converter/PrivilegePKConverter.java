...
public class PrivilegePKConverter extends StrutsTypeConverter {
	private Logger logger = LoggerFactory.getLogger(PrivilegePKConverter.class);
	
	@Override
	public Object convertFromString(Map context, String[] values, Class toClass) {
		logger.info("进入PrivilegePKConverter");
		logger.info("字符串------>对象");
	...
	public String convertToString(Map context, Object o) {
		logger.info("进入PrivilegePKConverter");
		logger.info("对象------>字符串");
		PrivilegePK privilegePK =  (PrivilegePK) o;
		return privilegePK.getModule() + WebConstant.WEB_LINK_CHAR + privilegePK.getPrivilege();
	}
